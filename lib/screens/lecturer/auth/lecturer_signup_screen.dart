    ...
    try {
      ...
      if (user != null) {
        ...
        if (!lecturerDoc.exists) {
          // Save lecturer details in Firestore with status 'pending' and role 'lecturer'
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text("Sign-up successful! Await admin approval before logging in.")),
          );
