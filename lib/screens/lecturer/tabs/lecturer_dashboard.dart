...
import 'package:qr_attendance/screens/lecturer/attendance/reportscreen.dart';
...
class _LecturerDashboardState extends State<LecturerDashboard> {
  ...
  void _addUpcomingClass() async {
    ...
    final approvedCourses = (data != null && data.containsKey('courses'))
        ...
        content: Column(
          ...
          children: [
            DropdownButtonFormField<String>(
              ...
              items: approvedCourses.map((courseId) => DropdownMenuItem(
                value: courseId,
                child: Text(courseId),
              )).toList(),
              onChanged: (value) {
