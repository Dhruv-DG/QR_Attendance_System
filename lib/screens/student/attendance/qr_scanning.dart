...
class _QRScannerScreenState extends State<QRScannerScreen> {
  ...
  Future<void> _storeAttendance(String qrData) async {
    ...
    // Extract Session ID, Title, and Course Code from the QR data
    ...
    for (String part in dataParts) {
      ...
      } else if (part.startsWith("Course Code:")) {
        courseCode = part.replaceFirst("Course Code: ", "").trim();
      }
    }

    if (sessionId.isEmpty || sessionTitle.isEmpty || courseCode.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
