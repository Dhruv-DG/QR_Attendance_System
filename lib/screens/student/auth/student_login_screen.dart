...
import 'package:qr_attendance/screens/student/auth/student_signup_screen.dart';
              ...
              child: CircleAvatar(
                ...
                child: ClipOval(
                  child: Image.asset(
                    ...
                    width: 112,
                    height: 112,
                    errorBuilder: (context, error, stackTrace) => Icon(Icons.school, size: 70, color: Colors.white),
                  ),
                ),
              ),
            ),
